...
export const sendConnection = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `Error in sending connecton ${error}` });
  }
};
...
export const getConnectionStatus = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: "Error in getting connection status" });
  }
};
...
export const removeConnection = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "Error in removing connection" });
  }
};
